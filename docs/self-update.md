...
Leikwan Toolkit 1.1.1 增加自更新能力。自更新只使用 GitHub Release 包，不会直接拉取 raw main 分支脚本。
...
LAST_UPDATE_FROM=1.1.0
LAST_UPDATE_TO=1.1.1
LAST_UPDATE_RESULT=ok
LAST_UPDATE_BACKUP=/var/backups/leikwan-toolkit/root__leikwan-toolkit.sh.20260510-053000.bak
LAST_UPDATE_SOURCE=https://github.com/ike-sh/leikwan-toolkit/releases/download/v1.1.1/leikwan-toolkit-1.1.1.tar.gz
```

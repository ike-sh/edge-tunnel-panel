...
Leikwan Toolkit 1.3.5 继续增强“运维命令中心”，用于把日常维护入口集中到一个菜单，减少在多个子菜单之间来回查找。
...
- 常见故障修复：使用“自动修复常见问题”，等价于 `lq doctor --auto-fix`，只修复 nftables / MSS、DDNS timer、快捷命令、权限和 stale lock 等安全边界内的问题。

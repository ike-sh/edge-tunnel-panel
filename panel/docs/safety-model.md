...
Leikwan Panel `3.0.0-alpha.4` is a demo apply release with a narrow write boundary.
...
`3.0.0-alpha.4` enables fixed alpha actions only when an Agent has `enable_write_actions=true`:

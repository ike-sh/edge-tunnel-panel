...
`3.0.0-alpha.4` is the first release that can ask a write-enabled Agent to do a tiny set of fixed actions. This is a demo path for validating install and basic Panel workflow.

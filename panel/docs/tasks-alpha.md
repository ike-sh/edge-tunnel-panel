...
Leikwan Panel `3.0.0-alpha.4` hardens the minimal Agent task system for readonly diagnostics.
...
Future write operations would require dry-run, snapshot, rollback, approval, strict write allowlists and audit trails. They are not part of 3.0.0-alpha.4.
...
## 3.0.0-alpha.4 Write Review Boundary
...
This document remains under its original filename for link compatibility. The readonly task system described here is part of Leikwan Panel 3.0.0-alpha.4.

...
var writeActions = map[string]bool{
	...
	"disable_entry_forward_config":   true,
	"disable_landing_forward_config": true,
	"disable_network_link":           true,
	"cleanup_node_deployment":        true,
	"purge_agent_deployment":         true,
